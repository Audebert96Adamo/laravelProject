            ...
            <form method="post" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  @enderror
                  <input name="portfolio_name" class="form-control" type="text" value="{{ $portfolio->portfolio_name }}" placeholder="" id="">
                </div>
              </div>
              <!-- end row -->
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                  <input name="portfolio_title" class="form-control" type="text" value="{{ $portfolio->portfolio_title }}" placeholder="" id="">
                </div>
              </div>
              <!-- end row -->
              <!-- FORM EDITOR : id="elm1" -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <img id="showImage" class="rounded avatar-lg" src="{{ url($portfolio->portfolio_image) }}" alt="Card image cap">
                </div>
              </div>
              <!-- end row -->
