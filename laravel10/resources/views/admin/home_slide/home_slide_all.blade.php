          ...
          <div class="card-body">
            ...
            <form method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="title" class="form-control" type="text" placeholder="" value="{{ $homeslide->title }}" id="">
                </div>
              </div>
              <!-- end row -->
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="short_title" class="form-control" type="text" placeholder="" value="{{ $homeslide->short_title }}" id="">
                </div>
              </div>
              <!-- end row -->
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="video_url" class="form-control" type="text" placeholder="" value="{{ $homeslide->video_url }}" id="">
                </div>
              </div>
              <!-- end row -->
              <div class="row mb-3">
